...
rg -q 'mindcreek-gateway:phase3' "$ROOT/scripts/build-gateway-image-offline.sh" || fail "Phase 3 image tag is absent"
rg -q '0.4.0-phase3' "$ROOT/deploy/phase1/compose.gateway.yml" || fail "Phase 3 product version is absent"
