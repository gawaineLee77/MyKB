...
[ "$(grep -cF 'MAX_FILE_SIZE_MB: ${MAX_FILE_SIZE_MB:-200}' "$ROOT/deploy/phase5/compose.managed-models.yml")" -eq 4 ] || fail "the upload limit is not shared by frontend, gateway, app, and docreader"
