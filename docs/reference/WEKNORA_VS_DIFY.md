...
> Dated architecture comparison, retained as decision context rather than a current benchmark or feature inventory. Revalidate versions and measurements before a new selection; see the [roadmap](../ROADMAP.md).
